...
if(isset($_POST['delete'])){
    ...
    if($verify_delete->rowCount() > 0){
        ...
        $warning_msg[] = '¡Ya se ha borrado el anuncio!';
    }
}
...
<body>
    ...
    <section class="listings">
        ...
        <h1 class="heading">Todas los Anuncios</h1>

        <form action="" method="POST" class="search-form">
            <input type="text" name="search_box" placeholder="Buscar Publicación..." maxlength="100" required>
    ...
    ?>
            <div class="box">
                <div class="thumb">
                    ...
                    <img src="../images/Images_Subidas/<?= $fetch_listing['image_01']; ?>" alt="">
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <a href="view_property.php?get_id=<?= $listing_id; ?>" class="btn">Ver Propiedad</a>
                    <input type="submit" value="Eliminar Anuncio"
                        onclick="return confirm('¿Eliminar esta Publicación?');" name="delete" class="delete-btn">
                </form>
            </div>
            <?php
            }
            ...
            echo '<p class="empty">¡Aún no se ha publicado ninguna Propiedad!</p>';
        }
    ?>
