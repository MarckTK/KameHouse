...
if(isset($_POST['delete'])){
    ...
    if($verify_delete->rowCount() > 0){
        ...
        $success_msg[] = '¡Anuncio Eliminado!';
    }else{
        $warning_msg[] = 'Ya se ha Eliminado el anuncio!';
    }
}
    ...
    <section class="view-property">
        ...
        <div class="details">
            ...
            <form action="" method="post" class="flex-btn">
                ...
                <input type="submit" value="Eliminar Propiedad" name="delete" class="delete-btn"
        ...
        <?php
            ...
            echo '<p class="empty">¡Propiedad no Encontrada! <a href="listings.php" style="margin-top:1.5rem;" class="option-btn">Ir a los Anuncios</a></p>';
        }
        ?>
    </section>
    <!-- Fin Ver Propiedades -->
