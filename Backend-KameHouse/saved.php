...
<head>
    ...
    <title>Propiedades Guardadas</title>
...
<body>
    ...
    <!-- Sección Guardar Propiedades -->
    <section class="listings">

        <h1 class="heading">Propiedades Guardadas</h1>
        ...
        <div class="box-container">
            ...
            <?php
                    ...
                    echo '<p class="empty">¡Aún no tienes Propiedades Guardadas! <a href="listings.php" style="margin-top:1.5rem;" class="btn">Descubrir más Propiedades</a></p>';
                }
            ?>
        </div>

    </section>
    <!-- Fin Guardar Propiedades -->
