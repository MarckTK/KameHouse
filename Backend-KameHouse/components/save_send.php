...
if(isset($_POST['save'])){
    if($user_id != ''){
        ...
        if($verify_saved->rowCount() > 0){
            ...
            $success_msg[] = '¡Eliminado de Propiedades Guardadas!';
        }else{
            ...
            $success_msg[] = '¡Propiedad Guardada!';
        }

    }else{
        $warning_msg[] = '¡Por favor, Inicie Sesión primero!';
    }
}
...
if(isset($_POST['send'])){
    if($user_id != ''){
        ...
        if(($verify_request->rowCount() > 0)){
            ...
            $success_msg[] = '¡Solicitud Enviada con Éxito!';
        }
