...
<body>
    ...
    <!-- Sección Buscar Propiedades -->
    <section class="filters" style="padding-bottom: 0;">

        <form action="" method="post">
            <div id="close-filter"><i class="fas fa-times"></i></div>
            <h3>Filtro de Nueva Búsqueda</h3>

            <div class="flex">

                <div class="box">
                    <p>Ingresa la Localización</p>
                    <input type="text" name="location" required maxlength="50" placeholder="Ingresa Nombre de la Ciudad"
                        class="input">
                </div>
                <div class="box">
                    <p>Tipo de Oferta</p>
    ...
    <section class="listings">
        ...
        if(isset($_POST['h_search']) or isset($_POST['filter_search'])){
            ...
            echo '<h1 class="heading">Últimas Propiedades</h1>';
        }
    ?>
        ...
        ?>
            <form action="" method="POST">
                ...
                ?>
                    <button type="submit" name="save" class="save"><i
                            class="far fa-heart"></i><span>Guardar</span></button>
                    <?php
                }
                ?>
                    <div class="thumb">
            ...
            echo '<p class="empty">Por el momento no hay una Propiedad con tus características :(</p>';
        }
        ?>
        </div>
    </section>
    <!-- Fin Sección Todas las Propiedades -->
